...
class CouponsNFT(
    ...
    def __init__(self, total_supply, merchant, expiration_date, coupon_code, coupon_id, description, admin, metadata, token_metadata={}, ledger={}, policy=None, metadata_base=None):
...
class CouponsFactory(sp.Contract):
    ...
    @sp.entry_point
    def create_couponNFT_contract(self, total_supply, merchant, expiration_date, coupon_code, coupon_id, description, metadata):
        ...
        deployedContract = sp.create_contract(
            contract=couponsNFTContract
        )
