...
const CouponCard = ({ index, image_src, coupon_code, description, merchant, expiration_date }: { index: number, image_src: string, coupon_code: string, description: string, merchant: string, expiration_date: string }) => {
